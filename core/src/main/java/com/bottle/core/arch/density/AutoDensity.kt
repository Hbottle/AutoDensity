package com.bottle.core.arch.density
...
class AutoDensity private constructor() : ActivityLifecycleCallbacks, ComponentCallbacks {
    ...
    companion object {
        val TAG = AutoDensity::class.java.simpleName
    ...
    private fun apply(activity: Activity, designDraft: DesignDraft) {
        ...
        targetDensity = if (designDraft.isBaseOnSmallestWidth) {
    ...
    override fun onActivityCreated(activity: Activity, savedInstanceState: Bundle?) {
        if (autoDensityConfig == null || customAdaptManager == null) {
            return
        }
        ...
        var designDraft = if (activity is CustomAdapt) {
